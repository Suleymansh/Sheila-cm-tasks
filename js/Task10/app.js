// function ishidden(sent) {
//    if(sent.includes('gizli')=== derse gel ){
//  return derse gel
//    }
//    else{
//     return false
...
//  bu shekilde  de yaza bilerik
//  const ishidden =(sent)=> sent.includes('gizli')
//  console.log( ishidden(cumle));
// console.log(ishidden(cumle2));

// function fixClassNme(name){

//  console.log(name.replaceAll(' ', '_'));

// }
// fixClassNme("green btn");
