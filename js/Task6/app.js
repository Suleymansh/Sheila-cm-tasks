...
// console.log(genNum(3, 300));
//  const getGreeting=( userName, job)=>{

// console.log( ` ${userName}, ${job} devloper`);
//  }
//  getSoz( ' shakocuk', ' js')
...
// function capitalFinder(paytaxt){
//   if( paytaxt==="aze"){
//     return ' Baku'
//   }

//   else if (paytaxt === "tr") return " Ankara";

//   else if (paytaxt === "rus") return " Moskva";
//   else {
//     return "this is not country";
//   }
...
// function translateCountry (translate) {
//   switch (translate) {
//     case "az":
...
//       return " welcome";
//     case "alm":
//       return "Willkommen zu";
//     default:
//       return "this is not languuage";
//   }
// }

// console.log(translateCountry("alm"));

// function greaterThan(ed) {
//   if (ed > 100) {
//     return true;
//   } else  {
//     return false;
//   }
// }
// console.log(greaterThan(50));
//  function surnameGenertor( name, language, gender) {

//   let _language = gender === 'w' ? language+ 'ev' : language +'eva'
//   return  ` ${ name} + ${ language}`
//  }
//  let eded= prompt('emriniz nedir?')
//  if ( eded==='q' ){
//   console.log('bash uste')
//  } else{
//   console.log(eded)
//  }
...
//   soz = prompt('emrinizi deyin plss:')
//  console.log(' bash uste');
//  }
